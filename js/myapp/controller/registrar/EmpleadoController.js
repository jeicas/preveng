Ext.define('myapp.controller.registrar.EmpleadoController', {
    ...
    init: function (application) {
        this.control({
            ...
            "#empleado combobox[name=estadonombre]": {
                select: this.selectestado
            },
            "#empleado combobox[name=municipionombre]": {
                select: this.selectmunicipio
            },
            "#empleado combobox[name=parroquianombre]": {
                select: this.selectparroquia
            },
            ...
            "#empleado combobox[name=cmbinstitucion]": {
                select: this.selectinstitucion
            },
            "#empleado combobox[name=cmbdependencia]": {
                select: this.selectdependencia
            },
             "#empleado combobox[name=cmbdivision]": {
                select: this.selectdivision
            },
        });
    },
    ...
    onButtonClickagregarEmpleados: function (button, e, options) {
        ...
        if (record[0]) {
            if (record.length == 1) {
                ...
                Ext.ComponentQuery.query('#empleado  combobox[name=cmbdependencia]')[0].setDisabled(false);
...
//COMBOS ANIDADOS ESTADO, MUNICIPIO PARROQUIA
    selectestado: function (cmb, record, index) {
        if (cmb.getValue() != '') {
            ...
            municipioStore = Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].getStore();
            Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].clearValue();
            Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].setDisabled(1);
            Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].reset();
            // Ext.ComponentQuery.query('#empleado textfield[name=municipio]')[0].reset();
            Ext.ComponentQuery.query('#empleado combobox[name=municipionombre]')[0].setDisabled(false);
            //municipioStore.proxy.extraParams.estado=Ext.ComponentQuery.query("combobox[name=estado]")[0].getValue();
            municipioStore.proxy.extraParams = {'estado': Ext.ComponentQuery.query("combobox[name=estadonombre]")[0].getValue()};

            municipioStore.load();
            Ext.ComponentQuery.query("textfield[name=cmbestado]")[0].setValue(Ext.ComponentQuery.query("combobox[name=estadonombre]")[0].getValue());
        } else {
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].reset();
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].setDisabled(false);
        }
    ...
    selectmunicipio: function (cmb, record, index) {
        parroquiaStore = Ext.ComponentQuery.query("combobox[name=parroquianombre]")[0].getStore();
        Ext.ComponentQuery.query("combobox[name=parroquianombre]")[0].clearValue();
        Ext.ComponentQuery.query("combobox[name=parroquianombre]")[0].setDisabled(1);
        Ext.ComponentQuery.query("combobox[name=parroquianombre]")[0].reset();
        Ext.ComponentQuery.query('#empleado combobox[name=parroquianombre]')[0].setDisabled(false);
        parroquiaStore.proxy.extraParams = {'municipio': Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].getValue()};
        parroquiaStore.load();
        Ext.ComponentQuery.query("textfield[name=cmbmunicipio]")[0].setValue(Ext.ComponentQuery.query("combobox[name=municipionombre]")[0].getValue());

    },
    selectparroquia: function (cmb, record, index) {

        Ext.ComponentQuery.query("textfield[name=cmbparroquia]")[0].setValue(Ext.ComponentQuery.query("combobox[name=parroquianombre]")[0].getValue());
...
/////////////////Cambiar edad
    ...
    displayage: function (yr, mon, day, unit, decimal, round) {
      ...
      selectinstitucion: function (cmb, record, index) {
        if (cmb.getValue() != '') {
            storeDependencia = Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].getStore();
            Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].clearValue();
            Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].setDisabled(1);
            Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].reset();
            // Ext.ComponentQuery.query('#empleado cmbdependencia[name=municipio]')[0].reset();
            Ext.ComponentQuery.query('#empleado combobox[name=cmbdependencia]')[0].setDisabled(false);
            //municipioStore.proxy.extraParams.estado=Ext.ComponentQuery.query("combobox[name=estado]")[0].getValue();
            storeDependencia.proxy.extraParams = {'institucion': Ext.ComponentQuery.query("combobox[name=cmbinstitucion]")[0].getValue()};

            storeDependencia.load();
            Ext.ComponentQuery.query("textfield[name=institucion]")[0].setValue(Ext.ComponentQuery.query("combobox[name=cmbinstitucion]")[0].getValue());
        } else {
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].reset();
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].setDisabled(false);
        }
     ...
     selectdependencia: function (cmb, record, index) {
        if (cmb.getValue() != '') {
            storeDivision = Ext.ComponentQuery.query("combobox[name=cmbdivision]")[0].getStore();
            Ext.ComponentQuery.query("combobox[name=cmbdivision]")[0].clearValue();
            Ext.ComponentQuery.query("combobox[name=cmbdivision]")[0].setDisabled(1);
            Ext.ComponentQuery.query("combobox[name=cmbdivision]")[0].reset();
            // Ext.ComponentQuery.query('#empleado cmbdependencia[name=municipio]')[0].reset();
            Ext.ComponentQuery.query('#empleado combobox[name=cmbdivision]')[0].setDisabled(false);
            //municipioStore.proxy.extraParams.estado=Ext.ComponentQuery.query("combobox[name=estado]")[0].getValue();
            storeDivision.proxy.extraParams = {'dependencia': Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].getValue()};

            storeDivision.load();
            Ext.ComponentQuery.query("textfield[name=dependencia]")[0].setValue(Ext.ComponentQuery.query("combobox[name=cmbdependencia]")[0].getValue());
        } else {
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].reset();
            Ext.ComponentQuery.query('#empleado textfield[name=local]')[0].setDisabled(false);
        }
    },
     selectdivision: function (cmb, record, index) {
        Ext.ComponentQuery.query("textfield[name=division]")[0].setValue(Ext.ComponentQuery.query("combobox[name=cmbdivision]")[0].getValue());
