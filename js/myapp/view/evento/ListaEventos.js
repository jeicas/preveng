        ...
        return [
            ...
            },
            {
                ...
                items: [{
                        ...
                        icon: '../../imagen/btn/pdf32.png',
                        handler: function (grid, rowIndex, colIndex) {
                            var evento = grid.getStore().getAt(rowIndex);
                            window.open(BASE_URL + 'pdfs/reportegeneralEvento/generarReporteEventoGeneral?idEv=' + evento.get('idEv'));
                        }
                    }]
            }]
    },
